...
module.exports = {
  ...
  webpackFinal: async (config) => {
    ...
    config.resolve.alias.Molecules = __dirname + "/../src/components/UI/molecules/index.tsx";
    config.resolve.alias.Organisms = __dirname + "/../src/components/UI/organisms/index.tsx";
